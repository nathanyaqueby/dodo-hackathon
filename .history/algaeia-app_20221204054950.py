        ...
        if choose4 == "yes":
            components.html('<html><head><script src="https://aframe.io/releases/1.0.4/aframe.min.js"></script>'
                            ...
                            #     '<a-asset-item id="propeller" src="./assets/propeller.gltf"></a-asset-item>'
                                ...
                                '<audio id="background" src="https://soundcloud.com/nqueby/dodo1?si=c722664ad9794709912a1187eb0c655c&utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing"></audio>'
                            '</a-assets>'
