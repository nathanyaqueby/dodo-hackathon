        ...
        with st.spinner('Loading...'):
            ...
            if choose4 == "yes":
                components.html('<html><head><script src="https://aframe.io/releases/1.0.4/aframe.min.js"></script>'
                                ...
                                '<'+choose+' position="-1 0.5 -3" rotation="10 10 0" color="#4CC3D9" sound="src: #background; autoplay: true; loop: true; volume: 2"></'+choose+'>'
                                '<'+choose+' position="-1 0.5 -3" rotation="30 10 0" color="#4CC3D9" sound="src: #background; autoplay: true; loop: true; volume: 2"></'+choose+'>'
