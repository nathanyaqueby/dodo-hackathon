    ...
    if generator:
        ...
        if choose4 == "yes":
            components.html('<html><head><script src="https://aframe.io/releases/1.0.4/aframe.min.js"></script>'
                            ...
                            '</head><body><a-scene><'+choose+' position="-1 0.5 -3" rotation="0 0 0" color="#4CC3D9" sound="src: '+audio_file+'; autoplay: true"></'+choose+'>'
                            '<a-light type='+choose2+' color="red" position="0 5 0"></a-light> '
                            '<a-entity environment="preset: '+choose3+'; groundColor: #445; grid: cross" sound="src: '+audio_file+'; autoplay: true" material="shader: ocean; color: blue; wave-height: 10">'+fog+'</a-entity>'
            ...
            components.html('<html><head><script src="https://aframe.io/releases/1.0.4/aframe.min.js"></script>'
                            ...
                            '<a-light type='+choose2+' color="red" position="0 5 0"></a-light> '
                            '<a-entity environment="preset: '+choose3+'; groundColor: #445; grid: cross" sound="src: '+audio_file+'; autoplay: true" material="shader: ocean; color: blue; wave-height: 10"></a-entity>'
                            '</a-scene></body></html>', height=600)
            # writeHelp1()
