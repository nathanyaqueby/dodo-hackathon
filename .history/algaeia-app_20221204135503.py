...
if st.sidebar.button('Visit the VR museum'):
...
if __name__ == '__main__':
    ...
    if generator:
        ...
        components.html('<html></head><body height=><embed src="https://www.sararutz.ch/DODO/index.html" style="width: 100%; height: 800%">')
