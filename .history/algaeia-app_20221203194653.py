...
if __name__ == '__main__':
    ...
    if generator:
        ...
        if choose4 == "yes":
            ...
            components.html('<html><head><script src="https://aframe.io/releases/1.0.4/aframe.min.js"></script><script src="https://unpkg.com/aframe-environment-component@1.1.0/dist/aframe-environment-component.min.js"></script><script src="https://unpkg.com/aframe-event-set-component@4.2.1/dist/aframe-event-set-component.min.js"></script></head><body><a-scene><'+choose+' position="-1 0.5 -3" rotation="0 0 0" color="#4CC3D9" sound="src: url(river.mp3); on: click"></><a-light type='+choose2+' color="red" position="0 5 0"></a-light> <a-entity environment="preset: '+choose3+'; groundColor: #445; grid: cross"></a-entity></a-scene></body></html>', height=600)
        # writeHelp1()
